...
int main (){
    ...
    switch(opcao){
        //*caso a variável opção armazene o valor 1, relativo a operação SOMA
        case 1://SOMA
          
            //*FAÇA ISSO
          
            //observe a mesma lógica nos códigos para soma, substração, multiplicação e divisão
            //escrevendo a instrução ao usuário
            printf("Digite o primeiro valor:\n");
            //espaço para ele digitar
            //%f pois pode ser inteiro ou quebrado
            //&num1 está armazenando o valor inteiro ou quebrado que foi digitado na variável num1
            scanf("%f", &num1);
            //instrução para o segundo valor
            printf("Digite o segundo valor:\n");
            //tipo de valor e armazenamento
            scanf("%f", &num2);
            //variável res RECEBE o cálculo da soma das variáveis
            //ou seja, variável res armazena o resultado do cálculo
            res = num1 + num2;
            //escrevendo o resultado
            //% no texto a ser substituído por uma variável que virá fora da string
            //%.2f pois é um número de ponto flutuante (variável float, número inteiro ou quebrado)
            //fora da string vem a variável que vai substituir o que está em % (se forem várias, sempre na ordem)
            printf("O resultado da adicao e: %.2f\n", res);

            //*PARE
            //break encerra o código da condição
            break;
        //depois do break a gente pode adicionar a próxima condição
      
        //caso a variável opção armazene o valor 2, relativo a operação subtração
        case 2://SUBTRAÇÃO
            
            //*faça isso
            //mesma coisa, mas o sinal na hora de armazenar o resultado é -
            printf("Digite o primeiro valor:\n");
            scanf("%f", &num1);
            printf("Digite o segundo valor:\n");
            scanf("%f", &num2);
            ...
            //*e pare
            break;
        //depois do break, podemos continuar
        //não preciso ficar repetindo essa explicação, até pq nos cases mais pra frente
        //vou usar o espaço pra falar sobre os códigos dessas equações mais complexas
